  ...
  return (
    ...
    >
      <table className="w-full border-collapse text-xs sm:text-sm">
        ...
        >
          <tr>
            <th className="w-[25%] px-2 sm:px-3 md:px-4 py-2 sm:py-3 text-left">Exchange</th>
            <th className="w-[20%] px-2 sm:px-3 md:px-4 py-2 sm:py-3 text-left">Provider</th>
            <th className="w-[35%] px-2 sm:px-3 md:px-4 py-2 sm:py-3 text-left">Region</th>
            <th className="w-[20%] px-2 sm:px-3 md:px-4 py-2 sm:py-3 text-right">Latency (ms)</th>
          </tr>
        </thead>
        <tbody>
